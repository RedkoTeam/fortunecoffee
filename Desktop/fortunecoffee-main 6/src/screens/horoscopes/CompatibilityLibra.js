...
import Librad from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Librad.png";
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Librad} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityLibra
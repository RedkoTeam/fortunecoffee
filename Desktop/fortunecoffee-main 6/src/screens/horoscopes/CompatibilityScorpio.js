...
import Scorpiod from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Scorpiod.png";
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Scorpiod} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityScorpio
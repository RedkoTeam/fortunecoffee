...
import Caprid from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Caprid.png";
...
function CompatibilityCapricorn({}) {
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Caprid} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityCapricorn
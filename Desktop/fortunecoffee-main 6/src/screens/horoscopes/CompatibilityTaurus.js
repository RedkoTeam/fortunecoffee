...
import Taurusd from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Taurusd.png";
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Taurusd} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityTaurus
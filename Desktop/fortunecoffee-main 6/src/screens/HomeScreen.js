   ...
   <Modal isVisible={isModalVisible}>
    <View style={{flex:1, alignItems: 'center',justifyContent: 'center', alignSelf:'center'}}>
          ...
          <TouchableOpacity style={{position: 'absolute', zIndex: 20, top: heightPercentageToDP(25), right: '5%'}} onPress={()=>{
              ...
              <Image source={xButton} style={{width: widthPercentageToDP(2), height: heightPercentageToDP(3),marginLeft:heightPercentageToDP(-19),marginTop:heightPercentageToDP(-5)}} />
          </TouchableOpacity>
            {/* GET CRYTSTALS */}

...
import coffeeImg from "../../assets/FortuneCoffeePNGassets/photoreadingbuttons/woman-1.png";
        ...
        <View style={styles.virtualContainer}>
            <ImageBackground source={readingBackground} style={styles.virtualOne}>
                ...
                <View style={styles.flexInRowsCoffee}>
                    ...
                    <View >
                        <Image source={coffeeImg} style={{ width :widthPercentageToDP('40'), height :heightPercentageToDP('25'), resizeMode:'contain',marginTop: heightPercentageToDP("5%") ,marginBottom: 20 ,justifyContent:'center', marginRight:'19%'}} />
                    </View>
                </View>

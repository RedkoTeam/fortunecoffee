...
const { saveAfterPayment } = require('./firebase/setData.js');
stripe.setApiVersion(config.stripe.apiVersion);

// Render the main app HTML.
router.get('/', (req, res) => {
  res.render('../public/amethyst.html');
});

router.get('/rose', (req, res) => {
  res.render('../public/rose.html');
});

router.get('/sapphire', (req, res) => {
  res.render('../public/sapphire.html');
});

router.get('/tiger', (req, res) => {
  res.render('../public/tiger.html');
});
...
// Create a new Customer --> Then Create Credit Card Token --> Then Save Card to Customer --> Then Save to Firebase
router.post('/api/customer', async (req, res) => {

  let price = "";

  try {
    // Creates a new customer on stripe first
    ...
    // Choose price for specific subscription
    switch (req.body.subscription) {
      case "Amethyst":
        price = 'price_1HpjdnAbvzShPvXhH8RizR25'
        break;
      case "Rose Quartz":
        price = 'price_1HpjdvAbvzShPvXhWgex2Er5'
        break;
      case "Sapphire":
        price = 'price_1HpjdRAbvzShPvXhPziLItqP'
        break;
      case "Tiger's Eye":
        price = 'price_1HrSklAbvzShPvXhB4p68ZSh'
        break;
    };
    ...
    // ofirebase.saveData(newPaidCustomer, () => res.sendStatus(200))

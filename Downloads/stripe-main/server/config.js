...
module.exports = {
  ...
  firebase_deployed: {
    apiKey: process.env.FIREBASE_DEPLOYED_API_KEY,
    authDomain: process.env.FIREBASE_DEPLOYED_AUTH_DOMAIN,
    databaseURL: process.env.FIREBASE_DEPLOYED_DATABASE_URL,
    projectId: process.env.FIREBASE_DEPLOYED_PROJECT_ID,
    storageBucket: process.env.FIREBASE_DEPLOYED_STORAGE_BUCKET,
    messagingSenderId: process.env.FIREBASE_DEPLOYED_MESSAGING_SENDER_ID,
    appId: process.env.FIREBASE_DEPLOYED_APP_ID,
    measurementId: process.env.FIREBASE_DEPLOYED_MEASUREMENT_ID
  },

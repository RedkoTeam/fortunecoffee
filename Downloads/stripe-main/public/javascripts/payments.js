...
(async () => {
  ...
  if (paymentRequestSupport) {
    ...
    document.querySelector('.instruction span').innerText = 'Enter';
  ...
  const updateButtonLabel = (paymentMethod, bankName) => {
    ...
    if(document.getElementById("page-title").textContent.includes("Amethyst")) {
      amount = 1.99
    }
    if(document.getElementById("page-title").textContent.includes("Rose")) {
      amount = 2.99
    }
    if(document.getElementById("page-title").textContent.includes("Sapphire")) {
      amount = 9.99
    }
    if(document.getElementById("page-title").textContent.includes("Tiger")) {
      amount = 19.99
    }

    document.getElementById("payment-button").textContent = `Pay $${amount}`
    document.getElementById("subtotal_price").textContent = "$" + amount
    document.getElementById("subscription_price").textContent = "$" + amount

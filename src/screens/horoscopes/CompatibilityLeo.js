...
import Leod from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Leod.png";
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Leod} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityLeo
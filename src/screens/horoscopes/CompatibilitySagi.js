...
import Sagid from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Sagid.png";
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Sagid} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilitySagi
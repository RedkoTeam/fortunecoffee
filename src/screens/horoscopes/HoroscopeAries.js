...
import {horoscopeArrayAries} from "../../arrays/horoscopeArrayAries";
...
import AriesCard from "../../../assets/FortuneCoffeePNGassets/horoscopes/horoscopebtns/Aries.png";
...
function HoroscopeAries({}) {
    ...
    const HoroscopeRandomizer = async () =>{
        ...
        if(!randomHoroscope){
            ...
            let random = Math.floor((Math.random() * horoscopeArrayAries.length))
                ...
                <View style={{ flex: 1, alignItems: 'center', marginTop:30 }}>
                    ...
                    <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'space-evenly' }}>
                        <View style={{ flexDirection: 'column', justifyContent: 'space-evenly' , marginRight:12}}>
                            ...
                            <Image source={number} style={{ width :widthPercentageToDP('15'), height :heightPercentageToDP('2'), resizeMode:'contain',marginTop: 10 }} />
                            ...
                            <Image source={appre} style={{ width :widthPercentageToDP('20'), height :heightPercentageToDP('2'), resizeMode:'contain',marginTop: 10 }} />
                            <Text style={{fontSize: actuatedNormalize (12), color:'white', marginTop:5,marginLeft:3}}> {randThanks}  </Text>

                        </View>
                        <Image source={AriesCard} style={{ width :widthPercentageToDP('30'), height :heightPercentageToDP('30'), resizeMode:'contain',justifyContent: 'space-evenly',left:"-5%"}} />
                    ...
                    <Image source={AriesTxt} style={{ alignItems: 'center', marginTop: 18, width :widthPercentageToDP('18'), height :heightPercentageToDP('3'), resizeMode:'contain' }} />
    ...
    function getRandomHoroscope(random) {
        console.log(random);
        let randHoroscope = horoscopeArrayAries[random];

...
import Piscesd from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Virgod.png";
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Piscesd} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityPisces
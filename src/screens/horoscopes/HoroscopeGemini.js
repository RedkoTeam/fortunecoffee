            ...
            <ScrollView directionalLockEnabled={true} automaticallyAdjustContentInsets={true} >
                ...
                <View style={{ flex: 1, alignItems: 'center', marginTop:30 }}>
                    ...
                    <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'space-evenly' }}>
                        ...
                        <Image source={GeminiCard} style={{ width :widthPercentageToDP('30'), height :heightPercentageToDP('30'), resizeMode:'contain',justifyContent: 'space-evenly',left:"-5%"}} />
                    ...
                    <Image source={GeminiTxt} style={{ alignItems: 'center', marginTop: 18, width :widthPercentageToDP('18'), height :heightPercentageToDP('3'), resizeMode:'contain' }} />

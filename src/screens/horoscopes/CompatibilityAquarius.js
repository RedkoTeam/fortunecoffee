...
import Aquariusd from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Aquariusd.png";
...
function CompatibilityAquarius({}) {
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Aquariusd} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityAquarius
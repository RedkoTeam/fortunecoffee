...
import Geminid from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/Geminid.png";
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Geminid} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityGemini
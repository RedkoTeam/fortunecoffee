...
import Cancerd from "../../../assets/FortuneCoffeePNGassets/horoscopes/compatibility/cancerd.png";
...
<Image source={gtcr} style={{marginRight: "50%"}}/>
                    ...
                    <Image source={Cancerd} style={{marginTop:widthPercentageToDP(4)}} />
...
export default CompatibilityCancer
        ...
        <View style={styles.virtualContainer}>
            <ImageBackground source={readingBackground} style={styles.virtualOne}>
                ...
                <View style={styles.flexInRowsCoffee}>
                    ...
                    <View >
                        <Image source={coffeeImg} style={{ width :widthPercentageToDP('40'), height :heightPercentageToDP('30'), resizeMode:'contain',marginTop: heightPercentageToDP("0%") ,marginBottom: 20 ,justifyContent:'center', marginRight:'25%'}} />
                    </View>
                </View>

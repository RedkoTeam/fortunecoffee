...
import fave from "../../../assets/FortuneCoffeePNGassets/Profile/profilebar.png";
...
<View style={{marginTop:"10%"}}>
    <Image source={fave} style={{marginTop:"-13%",marginBottom:"0%",marginLeft:'-2%', resizeMode: 'contain',width: widthPercentageToDP(120),height: heightPercentageToDP(20)}}/>
    </View>
    </View>
</TouchableOpacity>
    <ScrollView>
...
<ImageBackground source={profilebg} style={styles.bgfull1}>
    {isLoggedIn ? (
            <View>

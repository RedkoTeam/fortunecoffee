...
function NavBar({}){
    ...
    return(
        <View style={{ backgroundColor:'#070631'}}>
        <View style={{ backgroundColor:'#070631',  alignItems:'center', alignContent:'center',width: widthPercentageToDP('100'),marginBottom:'4%'}}>
        <Image source={Ellipse1} style={{ position: 'absolute', width: widthPercentageToDP('100'),height:heightPercentageToDP(18)}} />
